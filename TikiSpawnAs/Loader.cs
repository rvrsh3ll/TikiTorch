...
namespace TikiSpawnAs
{
    public sealed class Loader
    {
        ...
        public PROCESS_INFORMATION StartProcess(string path, string domain, string username, string password)
        {
        ...
        public void LoadAs(string targetProcess, byte[] shellcode, string domain, string username, string password)
        {

            var pinf = StartProcess(targetProcess, domain, username, password);
